...
class _ChatScreenState extends State<ChatScreen> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
  ...
  String _formatLastActive(DateTime? lastActive) {
    ...
    if (difference.inMinutes < 1) return 'Last active: Just now';
          ...
          Expanded(
            child: _cachedUserData == null
              ...
              children: [
                Semantics(
                  label:
                  'Profile image of ${_cachedUserData!['nickName'] ?? _cachedUserData!['fullName'] ?? widget.otherUserName}, tap to view profile',
  ...
  Widget _buildShimmerAppBar() {
    return Shimmer.fromColors(
      ...
      child: Row(
        children: [
          CircleAvatar(radius: 20, backgroundColor: Theme.of(context).colorScheme.surfaceVariant),
          const SizedBox(width: 12),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
